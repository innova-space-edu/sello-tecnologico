            ...
            <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pt-2 space-y-2">
                  ...
                  <button onClick={() => router.push('/proyectos')}
                    className="w-full border border-gray-300 text-gray-500 text-sm py-2.5 rounded-xl hover:bg-gray-50">
                    Ahora no
                  </button>
                </div>
              </div>
          ...
          {estado === 'aceptada' && (
            <div className="bg-white rounded-2xl shadow-sm p-10 text-center">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Tu copia del proyecto fue creada y está lista para completar.
              </p>
              <button
                onClick={() => router.push(proyectoCreado ? `/proyectos/${proyectoCreado}` : '/proyectos')}
