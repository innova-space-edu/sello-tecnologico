...
export default function NuevoProyectoPage() {
  ...
  const [form, setFormRaw] = useState({
    ...
    integrantes_roles: [] as string[],          // NUEVO
    // B — Curricular
    ...
    problema_detectado: '',                      // NUEVO
    evidencia_problema: '',                      // NUEVO
    preguntas_investigacion: [] as string[],     // NUEVO
    hipotesis: '',                               // NUEVO
    // D — Metodología
    ...
    // E — STEAM + IA
    steam_ciencia: '',                           // NUEVO
    steam_tecnologia: '',                        // NUEVO
    steam_ingenieria: '',                        // NUEVO
    steam_arte: '',                              // NUEVO
    steam_matematica: '',                        // NUEVO
    uso_ia: [] as string[], estrategia_verificacion: '',
    // F — Diseño y Producto
    objetivo_general: '',                        // NUEVO
    objetivos_especificos: [] as string[],       // NUEVO
    solucion_propuesta: '',                      // NUEVO
    boceto_descripcion: '',                      // NUEVO
    boceto_url: '',                              // NUEVO
    ...
    fuentes_consultadas: [] as string[],         // NUEVO
  })
        ...
        <form onSubmit={handleSubmit} className="max-w-3xl space-y-4">
          ...
          {tab === 2 && (
            <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
              ...
              {/* NUEVO — Preguntas de investigación */}
              <div>
                      ...
                      <div className="p-5 border-t border-blue-100 space-y-1 bg-white">
                        ...
                        <div className="mt-4">
                          ...
                          <textarea value={etapas.investigacion.hallazgos} onChange={e => updateEtapa('investigacion', 'hallazgos', e.target.value)}
                            rows={3} placeholder="¿Qué encontraron en la investigación? ¿Qué información recopilaron y qué conclusiones sacaron?" className={textareaClass} />
                        </div>
                      ...
                      <div className="p-5 border-t border-violet-100 space-y-1 bg-white">
                        ...
                        <div className="mt-4">
                          ...
                          <textarea value={etapas.diseno.criterios_diseno} onChange={e => updateEtapa('diseno', 'criterios_diseno', e.target.value)}
                            rows={3} placeholder="¿Qué requisitos debe cumplir el diseño? (funcionalidad, seguridad, costo, tamaño, etc.)" className={textareaClass} />
                        </div>
                        <div className="mt-3">
                      ...
                      <div className="p-5 border-t border-amber-100 space-y-1 bg-white">
                        ...
                        <div className="mt-3">
                          ...
                          <textarea value={etapas.desarrollo.roles_equipo} onChange={e => updateEtapa('desarrollo', 'roles_equipo', e.target.value)}
                            rows={3} placeholder="Ej: Estudiante A — programación / Estudiante B — ensamblaje / Estudiante C — documentación" className={textareaClass} />
                        </div>
                        <div className="mt-3">
                        ...
                        <div className="mt-3">
                          ...
                          <textarea value={etapas.desarrollo.obstaculos} onChange={e => updateEtapa('desarrollo', 'obstaculos', e.target.value)}
                            rows={3} placeholder="¿Qué dificultades surgieron durante el desarrollo? ¿Cómo las solucionaron?" className={textareaClass} />
                        </div>
                      ...
                      <div className="p-5 border-t border-green-100 space-y-1 bg-white">
                        ...
                        <div className="mt-3">
                          ...
                          <textarea value={etapas.evaluacion.retroalimentacion} onChange={e => updateEtapa('evaluacion', 'retroalimentacion', e.target.value)}
                            rows={3} placeholder="¿Qué retroalimentación dieron el docente, los pares o la comunidad sobre el proyecto?" className={textareaClass} />
                        </div>
                      ...
                      <div className="p-5 border-t border-rose-100 space-y-1 bg-white">
                        ...
                        <div className="mt-3">
                          ...
                          <textarea value={etapas.cierre.continuidad} onChange={e => updateEtapa('cierre', 'continuidad', e.target.value)}
                            rows={2} placeholder="¿Tiene este proyecto una continuación? ¿Se podría escalar o mejorar en el futuro?" className={textareaClass} />
                        </div>
          ...
          {tab === 4 && (
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
                ...
                <p className="text-sm text-gray-500">Justifica cada componente STEAM presente en el proyecto. Esto eleva el nivel pedagógico y asegura que no sea solo una maqueta.</p>

                <div className="space-y-3">
                  {[
                    { key: 'steam_ciencia' as const, emoji: '🔬', letra: 'S', nombre: 'Ciencia', color: 'blue', placeholder: '¿Qué concepto científico trabaja este proyecto? (ej: energía, ecosistemas, fuerzas...)' },
                    { key: 'steam_tecnologia' as const, emoji: '💻', letra: 'T', nombre: 'Tecnología', color: 'indigo', placeholder: '¿Qué tecnología se analiza, usa o propone? (ej: Arduino, app, sensor, algoritmo...)' },
                    { key: 'steam_ingenieria' as const, emoji: '⚙️', letra: 'E', nombre: 'Ingeniería', color: 'amber', placeholder: '¿Qué solución o diseño construirán? ¿Qué proceso de ingeniería aplican?' },
                    ...
                    { key: 'steam_matematica' as const, emoji: '📐', letra: 'M', nombre: 'Matemática', color: 'green', placeholder: '¿Qué mediciones, datos, porcentajes, comparaciones o gráficos usarán?' },
          ...
          {tab === 5 && (
            <div className="space-y-4">
              {/* NUEVO — Objetivo general y específicos */}
              <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
                ...
                {/* NUEVO — Boceto / Diseño preliminar */}
                <div className="border border-dashed border-gray-300 rounded-xl p-4 space-y-3 bg-gray-50">
                  ...
                  <div>
                    ...
                    <textarea value={form.boceto_descripcion} onChange={e => setForm({ ...form, boceto_descripcion: e.target.value })}
                      rows={3} placeholder="Describe el diseño o boceto del prototipo, solución o producto. ¿Cómo se verá? ¿Qué partes tiene?" className={textareaClass} />
                  </div>
                  <div>
              ...
              {/* Producto final — original intacto */}
              <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
