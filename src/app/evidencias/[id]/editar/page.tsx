...
export default function EditarEvidenciaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    router.push(`/evidencias/${evidenciaId}`)
  }
      ...
      <main className="lg:ml-64 flex-1 p-4 lg:p-8 pt-16 lg:pt-8">
        ...
        {noAutorizado && (
          <div className="flex flex-col items-center justify-center h-64 gap-4">
            ...
            <button onClick={() => router.push('/evidencias')}
              className="text-blue-600 text-sm hover:underline">← Volver</button>
          </div>
        )}
        ...
        {!loadingDatos && !noAutorizado && (
          <>
            <div className="mb-8">
              <button onClick={() => router.push(`/evidencias/${evidenciaId}`)}
                className="text-blue-600 text-sm hover:underline">← Volver a la evidencia</button>
              <h1 className="text-2xl font-bold text-blue-900 mt-2">Editar Evidencia</h1>
              <p className="text-gray-500 mt-1 text-sm">Modifica los datos de tu evidencia</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl">
              ...
              {/* Archivo */}
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h2 className="font-semibold text-blue-900 mb-4">📁 Reemplazar archivo (opcional)</h2>
                <div
