...
export default async function EditarFormatoAutoevaluacionPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!format) redirect('/autoevaluacion')
      ...
      <main className="lg:ml-64 flex-1 p-4 lg:p-8 pt-16 lg:pt-8">
        <div className="max-w-5xl mx-auto mb-5 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div>
            ...
            <h1 className="text-2xl font-bold text-blue-900 mt-2">Editar formato guardado</h1>
            <p className="text-gray-500 mt-1">Modifica este formato reutilizable de autoevaluación.</p>
          </div>
        </div>
        <FormatoAutoevaluacionEditor
          mode="edit"
          initialFormat={{
            id: format.id,
            title: format.title,
